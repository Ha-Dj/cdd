...
# data loader
trainloader = DataLoader(H5Dataset(r"/remote-home/jiedeng/cddfuse_msrs_data/MSRS_train_imgsize_128_stride_200.h5"),
...
save_path = f"/remote-home/jiedeng/cddfuse/models/CDDFuse_baseline_{num_epochs}_{epoch_gap}_"+timestamp+'.pth'
