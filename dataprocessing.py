...
IR_files = sorted(get_img_file(r"/remote-home/jiedeng/MSRS-main/train/ir"))
VIS_files   = sorted(get_img_file(r"/remote-home/jiedeng/MSRS-main/train/vi"))

assert len(IR_files) == len(VIS_files)
h5f = h5py.File(os.path.join('/remote-home/jiedeng/cddfuse_msrs_data',
...
with h5py.File(os.path.join('/remote-home/jiedeng/cddfuse_msrs_data',
